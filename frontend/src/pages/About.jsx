        ...
        <div className="font-sans bg-white">
            ...
            >
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">About GlobalFlow Logistics</h1>
            ...
            <section className="container mx-auto max-w-6xl px-4 py-16 text-center">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    <div className="bg-gray-100 p-6 rounded-lg shadow-md">
                        ...
                        <p className="text-gray-700">We ensure every shipment is delivered safely and on time.</p>
                    </div>
                    <div className="bg-gray-100 p-6 rounded-lg shadow-md">
                        <h4 className="font-bold text-xl mb-2">Integrity</h4>
                        <p className="text-gray-700">Honesty and transparency in every transaction we handle.</p>
                    </div>
                    <div className="bg-gray-100 p-6 rounded-lg shadow-md">
                        <h4 className="font-bold text-xl mb-2">Innovation</h4>
                        <p className="text-gray-700">We adopt modern technology to make logistics smarter and efficient.</p>
                    </div>
                </div>
            </section>
            ...
            {/* CTA Section */}
            <section className="container mx-auto max-w-6xl px-4 py-16 text-center">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Partner With Us</h2>
